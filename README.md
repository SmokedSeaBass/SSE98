# ![](SE98/places/64/start-here.png)SE98 Icon theme
A fork of nestoris's SE98 GNU/Linux icon theme that aims to add missing/incomplete icons.

# ![](SE98/status/64/dialog-information.png)Notes from original author
...
## ![](SE98/mimes/32/application-x-abiword.png)Description
